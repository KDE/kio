    ...
    , m_settings(new WebShortcutsSettings(this))
{
    ...
    // Set settings config file
    m_settings->setSharedConfig(KSharedConfig::openConfig(QString::fromUtf8(KURISearchFilterEngine::self()->name()) + QLatin1String("rc"), KConfig::NoGlobals));
