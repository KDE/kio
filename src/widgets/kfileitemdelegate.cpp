...
void KFileItemDelegate::drawSelectionEmblem(QStyleOptionViewItem option, QPainter *painter, int column) const
{
    if (column != 0 || !qApp->style()->styleHint(QStyle::SH_ItemView_ActivateItemOnSingleClick)) {
        return;
    }
