...
FilePreviewJob::CachePolicy FilePreviewJob::canBeCached(const QString &path)
{
    ...
    if (m_item.parentDirDeviceId == UnknownDeviceId) {
        return CachePolicy::Unknown;
    }

    bool isDifferentSystem = !m_item.parentDirDeviceId || m_item.parentDirDeviceId != m_currentDeviceId;
    ...
    if (isDifferentSystem) {
        ...
        checkedId = m_item.parentDirDeviceId;
    ...
    if (m_thumbRootDeviceId == UnknownDeviceId) {
        return CachePolicy::Unknown;
    }
