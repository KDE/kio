...
KIOCORE_EXPORT QString KIO::buildErrorString(int errorCode, const QString &errorText)
{
    ...
    */
    ...
    case KIO::ERR_FILE_TOO_LARGE_FOR_FAT32:
        result = xi18nc("@info",
                        "Cannot transfer <filename>%1</filename> because it is too large. The destination filesystem only supports files up to 4GiB",
                        errorText);
        break;
...
QStringList KIO::Job::detailedErrorStrings(const QUrl *reqUrl /*= 0*/, int method /*= -1*/) const
{
    ...
    ret2 += i18n("<li>Date and time: %1</li>", datetime) + i18n("<li>Additional information: %1</li>", errorText()) + QLatin1String("</ul>");
    if (!causes.isEmpty()) {
        ret2 += QLatin1String("<p>") + i18n("<b>Possible causes</b>:") + QLatin1String("</p><ul><li>") + causes.join(QLatin1String("</li><li>"))
            + QLatin1String("</li></ul>");
    }
    if (!solutions.isEmpty()) {
        ret2 += QLatin1String("<p>") + i18n("<b>Possible solutions</b>:") + QLatin1String("</p><ul><li>") + solutions.join(QLatin1String("</li><li>"))
            + QLatin1String("</li></ul>");
    }
...
KIOCORE_EXPORT QByteArray KIO::rawErrorDetail(int errorCode, const QString &errorText, const QUrl *reqUrl /*= 0*/, int /*method = -1*/)
{
    ...
    case KIO::ERR_CANNOT_OPEN_FOR_WRITING:
        ...
        description = i18n(
            ...
            KStringHandler::csqueeze(filename, s_maxFilePathLength));
    ...
    case KIO::ERR_IS_DIRECTORY:
        ...
        description = i18n(
            ...
            "folder <strong>%1</strong> was found instead.",
            path);
    ...
    case KIO::ERR_IS_FILE:
        ...
        description = i18n(
            ...
            "the file <strong>%1</strong> was found instead.",
            filename);
        causes << cBug;
        solutions << sUpdate << sSysadmin;
        break;
    ...
    case KIO::ERR_FILE_ALREADY_EXIST:
        ...
        solutions << i18n(
            ...
            "and then try again.")
                  << i18n("Delete the current file and try again.") << i18n("Choose an alternate filename for the new file.");
        break;
    ...
    case KIO::ERR_DIR_ALREADY_EXIST:
        ...
        solutions << i18n(
            ...
            "and then try again.")
                  << i18n("Delete the current folder and try again.") << i18n("Choose an alternate name for the new folder.");
        break;
    ...
    case KIO::ERR_NOT_FILTER_PROTOCOL:
        ...
        description = i18n(
            ...
            "<strong>%1%2</strong>.",
            !host.isNull() ? host + QLatin1Char('/') : QString(),
            path);
        causes << i18n(
            "KDE is able to communicate through a protocol within a "
    ...
    case KIO::ERR_UNKNOWN_PROXY_HOST:
        ...
        causes << i18n(
            ...
            "accessing the Internet with no problems recently, this is unlikely.")
               << cNetwork;
        solutions << i18n("Double-check your proxy settings and try again.") << sSysadmin;
        break;

    case KIO::ERR_CANNOT_AUTHENTICATE:
        errorName = i18n("Authentication Failed: Method %1 Not Supported", errorText);
        description = i18n(
            ...
            protocol);
        solutions << i18n(
            "Please file a bug at <a href=\"https://bugs.kde.org/\">"
    ...
    case KIO::ERR_CANNOT_SYMLINK:
        ...
        description = i18n("The requested symbolic link %1 could not be created.", errorText);
        causes << cAccess;
        solutions << sAccess;
        break;
    ...
    case KIO::ERR_FILE_TOO_LARGE_FOR_FAT32:
        ...
        description = xi18nc("@info",
                             "The file <filename>%1</filename> cannot be transferred,"
                             " because the destination filesystem does not support files that large",
                             errorText);
