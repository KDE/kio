...
Q_SIGNALS:
     ...
     * @param id the id of the request
     *
     * @deprecated since 5.79, use KIO::MultiGetJob::multiGetJobResult(long)
     */
    KIOCORE_DEPRECATED_VERSION(5, 79, "Use KIO::MultiGetJob::multiGetJobResult(long id)")
    void result(long id);
#endif
     ...
     * @since 5.79
     */
    void multiGetJobResult(long id);
