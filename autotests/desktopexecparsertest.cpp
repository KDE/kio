...
void DesktopExecParserTest::cleanupTestCase()
{
...
void DesktopExecParserTest::testDesktopExecParserWithEnv_data()
{
    QTest::addColumn<QString>("execLine");
    QTest::addColumn<QString>("expectedPath");
    QTest::addColumn<QString>("expectedName");
...
void DesktopExecParserTest::testDesktopExecParserWithEnv()
{
    QFETCH(QString, execLine);
    QFETCH(QString, expectedPath);
    QFETCH(QString, expectedName);
