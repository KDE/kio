...
void KDirListerTest::initTestCase()
{
    ...
    m_genericDataLocation = QStandardPaths::writableLocation(QStandardPaths::GenericDataLocation) + QLatin1String("/dirlister");
    m_tempDir.reset(new QTemporaryDir(m_genericDataLocation));
...
void KDirListerTest::testConcurrentListingAndStop()
{
    ...
    QTemporaryDir tempDir(m_genericDataLocation);
...
void KDirListerTest::testBug211472()
{
    ...
    QTemporaryDir newDir(m_genericDataLocation);
