...
#[=======================================================================[.rst:
ECMInstalledLibraryCheck (PREVIEW, shared for feedback)
-------------------------------------------------------
...
"
    ...
    if (CMAKE_GENERATOR STREQUAL "Ninja")
        # Ninja manages jobs based on resources
        set(_job_count)
    else()
        # with make (TODO: and which other?) give a number, to avoid endless number of jobs
        cmake_host_system_information(RESULT _job_count QUERY NUMBER_OF_LOGICAL_CORES)
    endif()
    ...
    add_custom_target(${_check_target_name}
        COMMAND ${CMAKE_COMMAND}
            ...
            --fresh
            .
        COMMAND ${CMAKE_COMMAND} --build . --parallel ${_job_count}
